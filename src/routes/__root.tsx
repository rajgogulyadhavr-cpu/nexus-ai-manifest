...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Rajalingam N" },
      { name: "theme-color", content: "#050814" },
      { property: "og:title", content: "Rajalingam N — AI & Data Science Engineer | Portfolio" },
      { name: "twitter:title", content: "Rajalingam N — AI & Data Science Engineer | Portfolio" },
      ...
      { name: "twitter:description", content: "Award-winning AI portfolio of Rajalingam N — Artificial Intelligence & Data Science Engineer. Projects in ML, CV, IoT and MERN. Featuring NeuroClass AI, FootGuard AI, Kural AI and more." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/69716793-f005-4d8f-b4b7-942a622c493f/id-preview-9d56ec08--6e37bab1-0a53-4c51-9af3-18077a73eced.lovable.app-1783790990699.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/69716793-f005-4d8f-b4b7-942a622c493f/id-preview-9d56ec08--6e37bab1-0a53-4c51-9af3-18077a73eced.lovable.app-1783790990699.png" },
